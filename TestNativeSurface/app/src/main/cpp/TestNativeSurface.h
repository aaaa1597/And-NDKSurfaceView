...
JNIEXPORT void JNICALL Java_com_test_testnativesurface_NativeFunc_create(JNIEnv *env, jclass type, jint id);
JNIEXPORT void JNICALL Java_com_test_testnativesurface_NativeFunc_surfaceCreated(JNIEnv *env, jclass type, jint id, jobject surface);
JNIEXPORT void JNICALL  Java_com_test_testnativesurface_NativeFunc_surfaceChanged(JNIEnv *env, jclass type, jint id, jint width, jint height);
JNIEXPORT void JNICALL Java_com_test_testnativesurface_NativeFunc_surfaceDestroyed(JNIEnv *env, jclass type, jint id);

#ifdef __cplusplus
}
#endif

class CNativeSurface {
private:
...
public:
    CNativeSurface(int id);
    virtual ~CNativeSurface();
